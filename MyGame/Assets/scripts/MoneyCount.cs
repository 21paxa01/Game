...
public class MoneyCount : MonoBehaviour
{
    ...
    void Save()
    {
        ...
        FileStream file = new FileStream(@"D:\Game\MyGame\MoneyCount.dat",FileMode.Create);
    ...
    void Load()
    {
        if(File.Exists(@"D:\Game\MyGame\MoneyCount.dat"))
        {
            BinaryFormatter formatter = new BinaryFormatter();
            FileStream file = new FileStream(@"D:\Game\MyGame\MoneyCount.dat", FileMode.Open);
